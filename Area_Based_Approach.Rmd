...
polyLevel2_sf3 <- polyLevel2_sf3 %>%
  left_join(
# find points within polygons
wealth_in_level2 <-
       st_join(wealthsp, polyLevel2_sf3, join = st_within) %>%
       st_drop_geometry() %>%
                    group_by(ADM2_PCODE) %>%
